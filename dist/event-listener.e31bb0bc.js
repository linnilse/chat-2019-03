...
//firebase.js
var config = {
  apiKey: "AIzaSyBuE_7__vi7tyOXDlpqJvRGWcngglD4STg",
  authDomain: "fir-test-eba56.firebaseapp.com",
  databaseURL: "https://fir-test-eba56.firebaseio.com",
  projectId: "fir-test-eba56",
  storageBucket: "fir-test-eba56.appspot.com",
  messagingSenderId: "485923923708"
};
...
var messeges = db.ref().child("messeges"); //const messeges = db.ref().child("messeges").orderByChild("Name").equalTo("Karin");
...
$("#data").submit(function (event) {
  ...
  var primaryKey = messeges.push().key;
...
messeges.on('child_added', function (snapshot) {
  //console.log("A child was added!");
  //console.log(snapshot.val()); //write out the added child
  var myArray = document.getElementsByClassName("prepend_messege");
  console.log(myArray);
  ...
  $('#result').prepend("<div class=\"prepend_messege\">  \n                <p class=\"data-name\">".concat(snapshot.val().Name, "</p>\n                <p class=\"data-message\">").concat(snapshot.val().Message, "</p>\n                </div>"));
});
messeges.on('child_removed', function (snapshot) {
  console.log("A child was removed!");
  console.log(snapshot.val()); // write out the deleted child
});
messeges.on('child_changed', function (snapshot) {
  console.log("A change in one child has occurred!");
  console.log(snapshot.val()); // write out the modified child
});
},{"./firebase":"firebase.js","firebase/database":"node_modules/firebase/database/dist/index.esm.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/event-listener.e31bb0bc.js.map